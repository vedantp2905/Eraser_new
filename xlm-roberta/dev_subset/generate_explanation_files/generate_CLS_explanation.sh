...
layer=12
python ${scriptDir}/generate_CLS_explanation.py --dataset-name-or-path ${inputPath}/movie_dev_subset.json --task-name sst2 --model-name ${model} --tokenizer-name ${model} --save-dir ${saveDir}
